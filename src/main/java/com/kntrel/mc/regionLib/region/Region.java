...
/**
 * Represents a mutable 3D region with permissions, rules, and spatial bounds.
 * <p>
 * Regions are attached to a {@link RegionContext} and expose APIs for membership,
 * rule values, and ability checks. A region is also a geometric volume (a
 * {@link BoundingBox} in a {@link World}) that can be queried for containment
 * and overlap, displayed to players, and persisted via the context.
 */
