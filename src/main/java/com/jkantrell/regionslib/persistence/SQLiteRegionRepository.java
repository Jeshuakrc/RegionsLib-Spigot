package com.jkantrell.regionslib.persistence;
...
import com.jkantrell.regionslib.region.RegionRepository;
...
public class SQLiteRegionRepository implements RegionRepository {
    ...
    // CONSTRUCTORS
    public SQLiteRegionRepository(Plugin plugin, RegionContext context, URI databaseUri, HierarchyRepository hierarchyRepository) {
        DataSourceConfig dsConfig = new DataSourceConfig();
        dsConfig.setDriver("org.sqlite.JDBC");
        dsConfig.setUrl(databaseUri.toString());
